  ...
  return (
    <div id="root-page">
        <div className="root-header">
            ...
            <Icon as={CgMenu} onClick={onOpen} w={8} h={8} color='#fff' className='icon-cursor'/>
        </div>
        <Drawer
            isOpen={isOpen}
            placement='right'
        ...
        >
            ...
            <DrawerContent>
            <DrawerCloseButton />
            <DrawerHeader>Feliciano Castro</DrawerHeader>
            ...
            <DrawerFooter>
                <Link to={'/search'} onClick={onClose}>    
                    <Button rightIcon={<ChevronRightIcon />} color='newprimary.100' borderColor='newprimary.100' variant='outline'>
                        Buscar noticia
                    </Button>
                </Link>
            </DrawerFooter>
