...
function Search() {
  ...
  const postsSearch = async (parameter) => {
    let result = await axios.get(`https://felicianocastro.org/worpress/blog/wp-json/wp/v2/posts?per_page=50&search=${parameter}&_fields[]=title&_fields[]=date&_fields[]=id`)
