...
function Posts() {
    ...
    const categoriesSearch = async (id) => {
      let result = await axios.get(`https://felicianocastro.org/worpress/blog/wp-json/wp/v2/posts?categories=${id}&_fields[]=title&_fields[]=date&_fields[]=id&_fields[]=excerpt&_fields[]=jetpack_featured_media_url`)
